/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspDel_HostNameByRowGuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspDel_HostNameByRowGuid]
GO
*/

CREATE PROCEDURE [masterLists].[uspDel_HostNameByRowGuid]
...
================================================================================
Schema:      masterLists
Object:      uspDel_HostNameByRowGuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: [masterLists].[uspDel_HostNameByRowGuid]' );
...
EXEC masterLists.uspDel_HostNameByRowGuid
  @RowGuid = @RowGuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_HostNameByRowGuid';
GO