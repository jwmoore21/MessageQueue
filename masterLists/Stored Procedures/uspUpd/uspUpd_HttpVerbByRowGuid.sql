/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspUpd_HttpVerbByRowGuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspUpd_HttpVerbByRowGuid]
GO
*/

CREATE PROCEDURE [masterLists].[uspUpd_HttpVerbByRowGuid]
...
================================================================================
Schema:      masterLists
Object:      uspUpd_HttpVerbByRowGuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Update proc ran: [masterLists].[uspUpd_HttpVerbByRowGuid]' );
    ...
    END
      ...
      FROM #ChangeTableVar AS [ChangeTableVar]
        ...
        ON [HttpVerb].[RowGuid] = [ChangeTableVar].[RowGuid]
      ;
...
EXEC masterLists.uspUpd_HttpVerbByRowGuid
  @HttpVerb = @HttpVerb,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspUpd_HttpVerbByRowGuid';
GO