/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspDel_CountryTLDByRowGuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspDel_CountryTLDByRowGuid]
GO
*/
...
================================================================================
Schema:      masterLists
Object:      uspDel_CountryTLDByRowGuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: [masterLists].[uspDel_CountryTLDByRowGuid]' );
...
EXEC masterLists.uspDel_CountryTLDByRowGuid
  @RowGuid = @RowGuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_CountryTLDByRowGuid';
GO