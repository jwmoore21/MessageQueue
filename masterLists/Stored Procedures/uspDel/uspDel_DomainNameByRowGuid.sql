/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspDel_DomainNameByRowGuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspDel_DomainNameByRowGuid]
GO
*/

CREATE PROCEDURE [masterLists].[uspDel_DomainNameByRowGuid]
...
================================================================================
Schema:      masterLists
Object:      uspDel_DomainNameByRowGuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: [masterLists].[uspDel_DomainNameByRowGuid]' );
...
EXEC masterLists.uspDel_DomainNameByRowGuid
  @RowGuid = @RowGuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_DomainNameByRowGuid';
GO