/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspDel_CountryTLDWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspDel_CountryTLDWithAudit]
GO
*/

CREATE PROCEDURE [masterLists].[uspDel_CountryTLDWithAudit]
  @ccTLD CHAR(3),
...
================================================================================
Schema:      masterLists
Object:      uspDel_CountryTLDWithAudit
...
BEGIN
  ...
  */
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: [masterLists].[uspDel_CountryTLDWithAudit]' );
    ...
    (
      ...
      AND OBJECT_NAME([so].[parent_obj]) = 'CountryTLD'
    ...
    BEGIN
      ...
      /* Parent table has an update trigger enabled, and the audit table
         ...
         the auditing */
      DELETE FROM [masterLists].[CountryTLD]
      ...
      BEGIN
        ...
        */
        ...
        SELECT
          ...
          , [OutputTableVar].[Entity]
          , [OutputTableVar].[Notes]
        ...
        BEGIN TRY
          SELECT
            ...
            (
              ...
              WHERE
                [AuditCountryTLD].[AuditBatchId] = @_AuditBatchId
              FOR XML PATH ('CountryTLD'), ROOT ('DeletedRecords'), ELEMENTS XSINIL
            );
...
EXEC masterLists.uspDel_CountryTLDWithAudit
  @ccTLD = @ccTLD,
...
WHERE
  AuditCountryTLD.AuditBatchId = @AuditBatchId
;
*/
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_CountryTLDWithAudit';
GO