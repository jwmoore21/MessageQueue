/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspDel_HostNameWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspDel_HostNameWithAudit]
GO
*/

CREATE PROCEDURE [masterLists].[uspDel_HostNameWithAudit]
  @HostName VARCHAR(63),
...
================================================================================
Schema:      masterLists
Object:      uspDel_HostNameWithAudit
...
BEGIN
  ...
  */
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: [masterLists].[uspDel_HostNameWithAudit]' );
    ...
    (
      ...
      AND OBJECT_NAME([so].[parent_obj]) = 'HostName'
    ...
    BEGIN
      ...
      /* Parent table has an update trigger enabled, and the audit table
         ...
         the auditing */
      DELETE FROM [masterLists].[HostName]
        ...
        BEGIN TRY
          SELECT
            ...
            (
              ...
              WHERE
                [AuditHostName].[AuditBatchId] = @_AuditBatchId
              FOR XML PATH ('HostName'), ROOT ('DeletedRecords'), ELEMENTS XSINIL
            );
...
EXEC masterLists.uspDel_HostNameWithAudit
  @HostName = @HostName,
...
WHERE
  AuditHostName.AuditBatchId = @AuditBatchId
;
*/
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_HostNameWithAudit';
GO