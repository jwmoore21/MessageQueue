/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspUpd_EventTypeByRowGuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspUpd_EventTypeByRowGuid]
GO
*/

CREATE PROCEDURE [masterLists].[uspUpd_EventTypeByRowGuid]
...
================================================================================
Schema:      masterLists
Object:      uspUpd_EventTypeByRowGuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Update proc ran: [masterLists].[uspUpd_EventTypeByRowGuid]' );
    ...
    END
      ...
      FROM #ChangeTableVar AS [ChangeTableVar]
        ...
        ON [EventType].[RowGuid] = [ChangeTableVar].[RowGuid]
      ;
...
EXEC masterLists.uspUpd_EventTypeByRowGuid
  @EventType = @EventType,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspUpd_EventTypeByRowGuid';
GO