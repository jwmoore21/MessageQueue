/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[msgQueue].[uspDel_JsonSchemaWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [msgQueue].[uspDel_JsonSchemaWithAudit]
GO
*/

CREATE PROCEDURE [msgQueue].[uspDel_JsonSchemaWithAudit]
...
================================================================================
Schema:      msgQueue
Object:      uspDel_JsonSchemaWithAudit
...
BEGIN
  ...
  */
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: [msgQueue].[uspDel_JsonSchemaWithAudit]' );
...
EXEC msgQueue.uspDel_JsonSchemaWithAudit
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_JsonSchemaWithAudit';
GO