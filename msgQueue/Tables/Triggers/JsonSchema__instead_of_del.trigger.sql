/*
IF EXISTS ( SELECT 1 FROM sys.triggers WHERE object_id = object_id(N'[msgQueue].[TRG__JsonSchema__instead_of_del]'))
DROP TRIGGER [msgQueue].[TRG__JsonSchema__instead_of_del]
GO
*/
CREATE TRIGGER [msgQueue].[TRG__JsonSchema__instead_of_del] ON [msgQueue].[JsonSchema]
  INSTEAD OF DELETE
AS

/*******************************************************************************
Schema:      msgQueue
Object:      TRG__JsonSchema__instead_of_del
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = 'Autosave by: INSTEAD OF DELETE Trigger : TRG__JsonSchema__instead_of_del';
    ...
    FROM [msgQueue].[JsonSchema] AS recordsToErase
