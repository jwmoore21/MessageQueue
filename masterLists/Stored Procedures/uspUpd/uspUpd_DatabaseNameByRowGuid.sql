/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspUpd_DatabaseNameByRowGuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspUpd_DatabaseNameByRowGuid]
GO
*/

CREATE PROCEDURE [masterLists].[uspUpd_DatabaseNameByRowGuid]
...
================================================================================
Schema:      masterLists
Object:      uspUpd_DatabaseNameByRowGuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Update proc ran: [masterLists].[uspUpd_DatabaseNameByRowGuid]' );
    ...
    END
      ...
      FROM #ChangeTableVar AS [ChangeTableVar]
        ...
        ON [DatabaseName].[RowGuid] = [ChangeTableVar].[RowGuid]
      ;
...
EXEC masterLists.uspUpd_DatabaseNameByRowGuid
  @DatabaseName = @DatabaseName,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspUpd_DatabaseNameByRowGuid';
GO