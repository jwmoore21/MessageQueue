/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspDel_DatabaseNameWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspDel_DatabaseNameWithAudit]
GO
*/

CREATE PROCEDURE [masterLists].[uspDel_DatabaseNameWithAudit]
...
================================================================================
Schema:      masterLists
Object:      uspDel_DatabaseNameWithAudit
...
BEGIN
  ...
  */
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: [masterLists].[uspDel_DatabaseNameWithAudit]' );
...
EXEC masterLists.uspDel_DatabaseNameWithAudit
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_DatabaseNameWithAudit';
GO