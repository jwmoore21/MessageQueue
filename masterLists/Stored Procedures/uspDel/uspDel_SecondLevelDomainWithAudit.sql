/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspDel_SecondLevelDomainWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspDel_SecondLevelDomainWithAudit]
GO
*/

CREATE PROCEDURE [masterLists].[uspDel_SecondLevelDomainWithAudit]
...
================================================================================
Schema:      masterLists
Object:      uspDel_SecondLevelDomainWithAudit
...
BEGIN
  ...
  */
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: [masterLists].[uspDel_SecondLevelDomainWithAudit]' );
    ...
    (
      ...
      AND OBJECT_NAME([so].[parent_obj]) = 'SecondLevelDomain'
    ...
    BEGIN
      ...
      /* Parent table has an update trigger enabled, and the audit table
         ...
         the auditing */
      DELETE FROM [masterLists].[SecondLevelDomain]

      WHERE
        [SecondLevelDomain].[SecondLevelDomain] = @_SecondLevelDomain
        AND [SecondLevelDomain].[ccTLD] = @_ccTLD
      ;
    ...
    BEGIN
      ...
      BEGIN
        ...
        OUTPUT
          ...
          , [DELETED].[RowGuid]
          , [DELETED].[SecondLevelDomainDescription]
        ...
        */
        ...
        SELECT
          ...
          , [OutputTableVar].[SecondLevelDomainDescription]
        ...
        BEGIN TRY
          SELECT
            ...
            (
              ...
              WHERE
                [AuditSecondLevelDomain].[AuditBatchId] = @_AuditBatchId
              FOR XML PATH ('SecondLevelDomain'), ROOT ('DeletedRecords'), ELEMENTS XSINIL
            );
...
EXEC masterLists.uspDel_SecondLevelDomainWithAudit
...
WHERE
  AuditSecondLevelDomain.AuditBatchId = @AuditBatchId
;
*/
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_SecondLevelDomainWithAudit';
GO