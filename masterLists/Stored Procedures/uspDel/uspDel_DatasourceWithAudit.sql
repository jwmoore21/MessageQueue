/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspDel_DatasourceWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspDel_DatasourceWithAudit]
GO
*/

CREATE PROCEDURE [masterLists].[uspDel_DatasourceWithAudit]
...
================================================================================
Schema:      masterLists
Object:      uspDel_DatasourceWithAudit
...
BEGIN
  ...
  */
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: [masterLists].[uspDel_DatasourceWithAudit]' );
...
EXEC masterLists.uspDel_DatasourceWithAudit
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_DatasourceWithAudit';
GO