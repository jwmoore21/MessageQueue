/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspDel_DatabaseSchemaByRowGuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspDel_DatabaseSchemaByRowGuid]
GO
*/

CREATE PROCEDURE [masterLists].[uspDel_DatabaseSchemaByRowGuid]
...
================================================================================
Schema:      masterLists
Object:      uspDel_DatabaseSchemaByRowGuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: [masterLists].[uspDel_DatabaseSchemaByRowGuid]' );
...
EXEC masterLists.uspDel_DatabaseSchemaByRowGuid
  @RowGuid = @RowGuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_DatabaseSchemaByRowGuid';
GO