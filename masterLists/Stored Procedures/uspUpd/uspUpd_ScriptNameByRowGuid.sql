/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspUpd_ScriptNameByRowGuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspUpd_ScriptNameByRowGuid]
GO
*/

CREATE PROCEDURE [masterLists].[uspUpd_ScriptNameByRowGuid]
...
================================================================================
Schema:      masterLists
Object:      uspUpd_ScriptNameByRowGuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Update proc ran: [masterLists].[uspUpd_ScriptNameByRowGuid]' );
    ...
    END
      ...
      FROM #ChangeTableVar AS [ChangeTableVar]
        ...
        ON [ScriptName].[RowGuid] = [ChangeTableVar].[RowGuid]
      ;
...
EXEC masterLists.uspUpd_ScriptNameByRowGuid
  @ScriptName = @ScriptName,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspUpd_ScriptNameByRowGuid';
GO