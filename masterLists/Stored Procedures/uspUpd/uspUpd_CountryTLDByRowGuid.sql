/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspUpd_CountryTLDByRowGuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspUpd_CountryTLDByRowGuid]
GO
*/

CREATE PROCEDURE [masterLists].[uspUpd_CountryTLDByRowGuid]
...
================================================================================
Schema:      masterLists
Object:      uspUpd_CountryTLDByRowGuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Update proc ran: [masterLists].[uspUpd_CountryTLDByRowGuid]' );
    ...
    END
      ...
      FROM #ChangeTableVar AS [ChangeTableVar]
        ...
        ON [CountryTLD].[RowGuid] = [ChangeTableVar].[RowGuid]
      ;
...
EXEC masterLists.uspUpd_CountryTLDByRowGuid
  @ccTLD = @ccTLD,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspUpd_CountryTLDByRowGuid';
GO