/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspDel_StatusWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspDel_StatusWithAudit]
GO
*/

CREATE PROCEDURE [masterLists].[uspDel_StatusWithAudit]
  @RowStatus TINYINT,
...
BEGIN
  ...
  */
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: [masterLists].[uspDel_StatusWithAudit]' );
    ...
    (
      ...
      AND OBJECT_NAME([so].[parent_obj]) = 'Status'
    ...
    BEGIN
      ...
      /* Parent table has an update trigger enabled, and the audit table
         ...
         the auditing */
      DELETE FROM [masterLists].[Status]
      ...
      BEGIN
        ...
        */
        ...
        SELECT
          ...
          , [OutputTableVar].[StatusName]
          , [OutputTableVar].[StatusDescription]
        ...
        BEGIN TRY
          SELECT
            ...
            (
              ...
              WHERE
                [AuditStatus].[AuditBatchId] = @_AuditBatchId
              FOR XML PATH ('Status'), ROOT ('DeletedRecords'), ELEMENTS XSINIL
            );
...
EXEC masterLists.uspDel_StatusWithAudit
  @RowStatus = @RowStatus,
...
WHERE
  AuditStatus.AuditBatchId = @AuditBatchId
;
*/
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_StatusWithAudit';
GO