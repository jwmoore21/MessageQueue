/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspDel_SecondLevelDomainByRowGuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspDel_SecondLevelDomainByRowGuid]
GO
*/

CREATE PROCEDURE [masterLists].[uspDel_SecondLevelDomainByRowGuid]
...
================================================================================
Schema:      masterLists
Object:      uspDel_SecondLevelDomainByRowGuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: [masterLists].[uspDel_SecondLevelDomainByRowGuid]' );
...
EXEC masterLists.uspDel_SecondLevelDomainByRowGuid
  @RowGuid = @RowGuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_SecondLevelDomainByRowGuid';
GO