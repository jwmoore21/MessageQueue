/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[webuser].[uspDel_UserLoginByRowGuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [webuser].[uspDel_UserLoginByRowGuid]
GO
*/

CREATE PROCEDURE [webuser].[uspDel_UserLoginByRowGuid]
...
================================================================================
Schema:      webuser
Object:      uspDel_UserLoginByRowGuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: [webuser].[uspDel_UserLoginByRowGuid]' );
...
EXEC webuser.uspDel_UserLoginByRowGuid
  @RowGuid = @RowGuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_UserLoginByRowGuid';
GO