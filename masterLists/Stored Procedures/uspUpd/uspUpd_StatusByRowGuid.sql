/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspUpd_StatusByRowGuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspUpd_StatusByRowGuid]
GO
*/

CREATE PROCEDURE [masterLists].[uspUpd_StatusByRowGuid]
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Update proc ran: [masterLists].[uspUpd_StatusByRowGuid]' );
    ...
    END
      ...
      FROM #ChangeTableVar AS [ChangeTableVar]
        ...
        ON [Status].[RowGuid] = [ChangeTableVar].[RowGuid]
      ;
...
EXEC masterLists.uspUpd_StatusByRowGuid
  @RowStatus = @RowStatus,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspUpd_StatusByRowGuid';
GO