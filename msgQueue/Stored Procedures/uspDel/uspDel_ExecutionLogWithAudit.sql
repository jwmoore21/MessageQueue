/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[msgQueue].[uspDel_ExecutionLogWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [msgQueue].[uspDel_ExecutionLogWithAudit]
GO
*/

CREATE PROCEDURE [msgQueue].[uspDel_ExecutionLogWithAudit]
  @ExecutionLogId INT,
...
================================================================================
Schema:      msgQueue
Object:      uspDel_ExecutionLogWithAudit
...
BEGIN
  ...
  */
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: [msgQueue].[uspDel_ExecutionLogWithAudit]' );
...
EXEC msgQueue.uspDel_ExecutionLogWithAudit
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_ExecutionLogWithAudit';
GO