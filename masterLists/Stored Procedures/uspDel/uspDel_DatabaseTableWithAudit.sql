/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspDel_DatabaseTableWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspDel_DatabaseTableWithAudit]
GO
*/

CREATE PROCEDURE [masterLists].[uspDel_DatabaseTableWithAudit]
...
================================================================================
Schema:      masterLists
Object:      uspDel_DatabaseTableWithAudit
...
BEGIN
  ...
  */
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: [masterLists].[uspDel_DatabaseTableWithAudit]' );
...
EXEC masterLists.uspDel_DatabaseTableWithAudit
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_DatabaseTableWithAudit';
GO