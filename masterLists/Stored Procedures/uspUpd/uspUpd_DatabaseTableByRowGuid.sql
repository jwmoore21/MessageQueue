/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspUpd_DatabaseTableByRowGuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspUpd_DatabaseTableByRowGuid]
GO
*/

CREATE PROCEDURE [masterLists].[uspUpd_DatabaseTableByRowGuid]
...
================================================================================
Schema:      masterLists
Object:      uspUpd_DatabaseTableByRowGuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Update proc ran: [masterLists].[uspUpd_DatabaseTableByRowGuid]' );
    ...
    END
      ...
      FROM #ChangeTableVar AS [ChangeTableVar]
        ...
        ON [DatabaseTable].[RowGuid] = [ChangeTableVar].[RowGuid]
      ;
...
EXEC masterLists.uspUpd_DatabaseTableByRowGuid
  @DatabaseTable = @DatabaseTable,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspUpd_DatabaseTableByRowGuid';
GO