/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspDel_TopLevelDomainWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspDel_TopLevelDomainWithAudit]
GO
*/

CREATE PROCEDURE [masterLists].[uspDel_TopLevelDomainWithAudit]
...
================================================================================
Schema:      masterLists
Object:      uspDel_TopLevelDomainWithAudit
...
BEGIN
  ...
  */
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: [masterLists].[uspDel_TopLevelDomainWithAudit]' );
    ...
    (
      ...
      AND OBJECT_NAME([so].[parent_obj]) = 'TopLevelDomain'
    ...
    BEGIN
      ...
      /* Parent table has an update trigger enabled, and the audit table
         ...
         the auditing */
      DELETE FROM [masterLists].[TopLevelDomain]
    ...
    BEGIN
      ...
      BEGIN
        ...
        OUTPUT
          ...
          , [DELETED].[RowGuid]
          , [DELETED].[TopLevelDomainType]
          , [DELETED].[TopLevelDomainDescription]
        ...
        */
        ...
        SELECT
          ...
          , [OutputTableVar].[TopLevelDomainType]
          , [OutputTableVar].[TopLevelDomainDescription]
        ...
        BEGIN TRY
          SELECT
            ...
            (
              ...
              WHERE
                [AuditTopLevelDomain].[AuditBatchId] = @_AuditBatchId
              FOR XML PATH ('TopLevelDomain'), ROOT ('DeletedRecords'), ELEMENTS XSINIL
            );
...
EXEC masterLists.uspDel_TopLevelDomainWithAudit
...
WHERE
  AuditTopLevelDomain.AuditBatchId = @AuditBatchId
;
*/
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_TopLevelDomainWithAudit';
GO