/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspDel_FullyQualifiedDomainNameByRowGuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspDel_FullyQualifiedDomainNameByRowGuid]
GO
*/

CREATE PROCEDURE [masterLists].[uspDel_FullyQualifiedDomainNameByRowGuid]
...
================================================================================
Schema:      masterLists
Object:      uspDel_FullyQualifiedDomainNameByRowGuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: [masterLists].[uspDel_FullyQualifiedDomainNameByRowGuid]' );
...
EXEC masterLists.uspDel_FullyQualifiedDomainNameByRowGuid
  @RowGuid = @RowGuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_FullyQualifiedDomainNameByRowGuid';
GO