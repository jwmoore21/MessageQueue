/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspDel_HttpVerbWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspDel_HttpVerbWithAudit]
GO
*/

CREATE PROCEDURE [masterLists].[uspDel_HttpVerbWithAudit]
  @HttpVerb VARCHAR(8),
...
================================================================================
Schema:      masterLists
Object:      uspDel_HttpVerbWithAudit
...
BEGIN
  ...
  */
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: [masterLists].[uspDel_HttpVerbWithAudit]' );
...
EXEC masterLists.uspDel_HttpVerbWithAudit
  @HttpVerb = @HttpVerb,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_HttpVerbWithAudit';
GO