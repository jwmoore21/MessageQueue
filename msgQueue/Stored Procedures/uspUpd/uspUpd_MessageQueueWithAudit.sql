/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[msgQueue].[uspUpd_MessageQueueWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [msgQueue].[uspUpd_MessageQueueWithAudit]
GO
*/

CREATE PROCEDURE [msgQueue].[uspUpd_MessageQueueWithAudit]
...
================================================================================
Schema:      msgQueue
Object:      uspUpd_MessageQueueWithAudit
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Update proc ran: [msgQueue].[uspUpd_MessageQueueWithAudit]' );
    ...
    WHERE
      MessageQueueId = @_MessageQueueId
    ;
    /* ---------------------------------------------------------------------- */
...
EXEC msgQueue.uspUpd_MessageQueueWithAudit
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspUpd_MessageQueueWithAudit';
GO