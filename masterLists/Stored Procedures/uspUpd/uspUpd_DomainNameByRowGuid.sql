/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspUpd_DomainNameByRowGuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspUpd_DomainNameByRowGuid]
GO
*/

CREATE PROCEDURE [masterLists].[uspUpd_DomainNameByRowGuid]
...
================================================================================
Schema:      masterLists
Object:      uspUpd_DomainNameByRowGuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Update proc ran: [masterLists].[uspUpd_DomainNameByRowGuid]' );
    ...
    END
      ...
      FROM #ChangeTableVar AS [ChangeTableVar]
        ...
        ON [DomainName].[RowGuid] = [ChangeTableVar].[RowGuid]
      ;
...
EXEC masterLists.uspUpd_DomainNameByRowGuid
  @DomainName = @DomainName,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspUpd_DomainNameByRowGuid';
GO