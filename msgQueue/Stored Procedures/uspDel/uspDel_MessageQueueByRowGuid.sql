/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[msgQueue].[uspDel_MessageQueueByRowGuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [msgQueue].[uspDel_MessageQueueByRowGuid]
GO
*/

CREATE PROCEDURE [msgQueue].[uspDel_MessageQueueByRowGuid]
...
================================================================================
Schema:      msgQueue
Object:      uspDel_MessageQueueByRowGuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: [msgQueue].[uspDel_MessageQueueByRowGuid]' );
...
EXEC msgQueue.uspDel_MessageQueueByRowGuid
  @RowGuid = @RowGuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_MessageQueueByRowGuid';
GO