/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspUpd_SubHostNameWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspUpd_SubHostNameWithAudit]
GO
*/

CREATE PROCEDURE [masterLists].[uspUpd_SubHostNameWithAudit]
...
================================================================================
Schema:      masterLists
Object:      uspUpd_SubHostNameWithAudit
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Update proc ran: [masterLists].[uspUpd_SubHostNameWithAudit]' );
    ...
    BEGIN
      ...
      FROM #ChangeTableVar AS [ChangeTableVar]
        ...
        ON [SubHostName].[SubHostName] = [ChangeTableVar].[SubHostName]
      ;
...
EXEC masterLists.uspUpd_SubHostNameWithAudit
  @SubHostName = @SubHostName,
  @modified_by    = -73,
  @ReturnOutput   = 1,
  @ReturnAsTable  = 1,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspUpd_SubHostNameWithAudit';
GO