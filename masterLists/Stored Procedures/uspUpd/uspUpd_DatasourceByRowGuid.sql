/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspUpd_DatasourceByRowGuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspUpd_DatasourceByRowGuid]
GO
*/

CREATE PROCEDURE [masterLists].[uspUpd_DatasourceByRowGuid]
...
================================================================================
Schema:      masterLists
Object:      uspUpd_DatasourceByRowGuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Update proc ran: [masterLists].[uspUpd_DatasourceByRowGuid]' );
    ...
    END
      ...
      FROM #ChangeTableVar AS [ChangeTableVar]
        ...
        ON [Datasource].[RowGuid] = [ChangeTableVar].[RowGuid]
      ;
...
EXEC masterLists.uspUpd_DatasourceByRowGuid
  @Datasource = @Datasource,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspUpd_DatasourceByRowGuid';
GO