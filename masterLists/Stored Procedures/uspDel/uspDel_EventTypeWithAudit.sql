/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspDel_EventTypeWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspDel_EventTypeWithAudit]
GO
*/

CREATE PROCEDURE [masterLists].[uspDel_EventTypeWithAudit]
...
================================================================================
Schema:      masterLists
Object:      uspDel_EventTypeWithAudit
...
BEGIN
  ...
  */
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: [masterLists].[uspDel_EventTypeWithAudit]' );
...
EXEC masterLists.uspDel_EventTypeWithAudit
  @EventType = @EventType,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_EventTypeWithAudit';
GO