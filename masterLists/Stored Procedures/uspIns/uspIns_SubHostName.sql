/*
IF  EXISTS (SELECT * FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspIns_SubHostName]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspIns_SubHostName]
GO
*/

CREATE PROCEDURE [masterLists].[uspIns_SubHostName]
...
BEGIN
  ...
  BEGIN TRY
    ...
    /* ========================================================================= */
    /* Insert our record */
    INSERT INTO [masterLists].[SubHostName]
    (
         [SubHostName]
       , [RowStatus]
       , [CreatedBy]
    ...
    BEGIN
      ...
      BEGIN
        ...
        WHERE
          [SubHostName].[SubHostName] = @SubHostName
        ;
        ...
        BEGIN TRY
          ...
          SELECT
            ...
            (
              ...
              WHERE
                [SubHostName].[SubHostName] = @SubHostName
              FOR XML PATH ('SubHostName'), ROOT ('InsertedRecords'), ELEMENTS XSINIL
            );
...
EXEC masterLists.uspIns_SubHostName
  /* Non-identity / guid Primary Key(s) */
  @SubHostName     = @SubHostName,  /* Foreign Key(s) */
  @RowStatus       = @RowStatus,
  /* General Column Data */
  /* App User Id / Modified By Id */
  @ModifiedBy      = NULL,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspIns_SubHostName';
GO