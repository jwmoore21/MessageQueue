/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspDel_SubHostNameByRowGuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspDel_SubHostNameByRowGuid]
GO
*/

CREATE PROCEDURE [masterLists].[uspDel_SubHostNameByRowGuid]
...
================================================================================
Schema:      masterLists
Object:      uspDel_SubHostNameByRowGuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: [masterLists].[uspDel_SubHostNameByRowGuid]' );
...
EXEC masterLists.uspDel_SubHostNameByRowGuid
  @RowGuid = @RowGuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_SubHostNameByRowGuid';
GO