/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[webuser].[uspUpd_UserLoginWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [webuser].[uspUpd_UserLoginWithAudit]
GO
*/

CREATE PROCEDURE [webuser].[uspUpd_UserLoginWithAudit]
...
================================================================================
Schema:      webuser
Object:      uspUpd_UserLoginWithAudit
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Update proc ran: [webuser].[uspUpd_UserLoginWithAudit]' );
    ...
    BEGIN
      ...
      FROM #ChangeTableVar AS [ChangeTableVar]
        ...
        ON [UserLogin].[UserId] = [ChangeTableVar].[UserId]
      ;
...
EXEC webuser.uspUpd_UserLoginWithAudit
  @UserId = @UserId,
  @modified_by    = -73,
  @ReturnOutput   = 1,
  @ReturnAsTable  = 1,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspUpd_UserLoginWithAudit';
GO