/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspDel_ScriptNameByRowGuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspDel_ScriptNameByRowGuid]
GO
*/

CREATE PROCEDURE [masterLists].[uspDel_ScriptNameByRowGuid]
...
================================================================================
Schema:      masterLists
Object:      uspDel_ScriptNameByRowGuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: [masterLists].[uspDel_ScriptNameByRowGuid]' );
...
EXEC masterLists.uspDel_ScriptNameByRowGuid
  @RowGuid = @RowGuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_ScriptNameByRowGuid';
GO