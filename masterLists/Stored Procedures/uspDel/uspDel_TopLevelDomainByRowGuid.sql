/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[masterLists].[uspDel_TopLevelDomainByRowGuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [masterLists].[uspDel_TopLevelDomainByRowGuid]
GO
*/

CREATE PROCEDURE [masterLists].[uspDel_TopLevelDomainByRowGuid]
...
================================================================================
Schema:      masterLists
Object:      uspDel_TopLevelDomainByRowGuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: [masterLists].[uspDel_TopLevelDomainByRowGuid]' );
...
EXEC masterLists.uspDel_TopLevelDomainByRowGuid
  @RowGuid = @RowGuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_TopLevelDomainByRowGuid';
GO